...
namespace samsungce {
	...
	public:
		...
		ReactiveLitepp::ReadonlyProperty<nlohmann::json> Data = MakeReadonlyProperty<&EnergyPlanner::Data>([this]() { return _data; });
		ReactiveLitepp::ReadonlyProperty<std::string> Plan = MakeReadonlyProperty<&EnergyPlanner::Plan>([this]() { return _plan; });
