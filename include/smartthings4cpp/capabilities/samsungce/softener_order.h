...
namespace samsungce {
	...
	public:
		...
		ReactiveLitepp::ReadonlyProperty<bool> AlarmEnabled = MakeReadonlyProperty<&SoftenerOrder::AlarmEnabled>([this]() { return _alarmEnabled; });
		ReactiveLitepp::ReadonlyProperty<double> OrderThreshold = MakeReadonlyProperty<&SoftenerOrder::OrderThreshold>([this]() { return _orderThreshold; });
