...
namespace custom {
	...
	public:
		...
		ReactiveLitepp::ReadonlyProperty<std::string> WasherAutoSoftenerValue = MakeReadonlyProperty<&WasherAutoSoftener::WasherAutoSoftenerValue>([this]() { return _washerAutoSoftenerValue; });
