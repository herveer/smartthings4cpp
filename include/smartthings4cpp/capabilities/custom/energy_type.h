...
namespace custom {
	...
	public:
		...
		ReactiveLitepp::ReadonlyProperty<nlohmann::json> EnergySavingInfo{ [this]() { return _energySavingInfo; } };
		ReactiveLitepp::ReadonlyProperty<nlohmann::json> SupportedEnergySavingLevels{ [this]() { return _supportedEnergySavingLevels; } };
		ReactiveLitepp::ReadonlyProperty<bool> EnergySavingOperation{ [this]() { return _energySavingOperation; } };
		ReactiveLitepp::ReadonlyProperty<std::string> NotificationTemplateID{ [this]() { return _notificationTemplateID; } };
		ReactiveLitepp::ReadonlyProperty<bool> EnergySavingOperationSupport{ [this]() { return _energySavingOperationSupport; } };
