...
namespace custom {
	...
	public:
		...
		ReactiveLitepp::ReadonlyProperty<std::vector<std::string>> DisabledComponentsValue = MakeReadonlyProperty<&DisabledComponents::DisabledComponentsValue>([this]() { return _disabledComponentsValue; });
