...
namespace custom {
	...
	public:
		...
		ReactiveLitepp::ReadonlyProperty<std::vector<std::string>> DisabledCapabilitiesValue = MakeReadonlyProperty<&DisabledCapabilities::DisabledCapabilitiesValue>([this]() { return _disabledCapabilitiesValue; });
